...
export class DeclaracionVariable1 extends Expresion {
    ...
    * @param {Object} options
    * @param {string} options.id Identificador de la variable
 * @param {string} options.tipo Tipo declarado de la variable
 * @param {Expresion} options.exp Expresion de la variable
    */
    constructor({ id, tipo, exp }) {
        super();
...
export default { Expresion, OperacionBinaria, ParseInt, OperacionUnaria, Agrupacion, Primitivo, DeclaracionVariable, DeclaracionVariable1, ReferenciaVariable, Print, ExpresionStmt, TypeOf, Asignacion, Bloque, If, While, For, Break, Continue, Return, Llamada, FuncDcl, Param, ClassDcl, Instancia, Get, Set }
