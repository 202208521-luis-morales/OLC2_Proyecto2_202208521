...
import { registers as r, floatRegisters as fR } from "./constantes.js";
...
export class Generador {
    ...
    feq(rs1, rs2, label) {
        this.instrucciones.push(new Instruction('feq.s', rs1, rs2, label))
    }
    ...
    bnez(rd, label ) {
        this.instrucciones.push(new Instruction('bnez', rd, label));
    }

    bgez(rd, label ) {
        this.instrucciones.push(new Instruction('bgez', rd, label));
    }
    ...
    popObjectByIndex(idx) {
        this.objectStack.slice(idx, 1);
    }
    ...
    */
    ...
    printObjectStack() {
        ...
        console.log({objectStack: this.objectStack});
    }
    ...
    toString() {
        ...
        return `
.data
error_msg: .asciz "Error: Invalid number format\\n"
true_msg: "true"
false_msg: "false"
        heap:
.text
...
`
    ...
    fcvtsw(rd, rs1, mode = undefined) {
        this.instrucciones.push(new Instruction('fcvt.s.w', rd, rs1, mode))
    }

    fcvtws(rd, rs1, mode = undefined) {
        this.instrucciones.push(new Instruction('fcvt.w.s', rd, rs1, mode))
    }
